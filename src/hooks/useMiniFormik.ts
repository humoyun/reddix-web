...
export function useMyFormik(props) {
  // defensive progaramming,
  if (!props.onSubmit) {
    throw new Error("You forgot to pass onSubmit to useMyFormik!");
  }
  ...
  // try to access event inside callback in React you should use persisit
